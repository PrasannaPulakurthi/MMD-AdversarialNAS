...
def main():
    ...
    args.exp_name = 'compress-'+args.compress_mode+'-'+args.dataset + '-' + args.exp_name
    ...
    if args.checkpoint:
        ...
        #except:
        #    new_state_dict = map_to_new_state_dict(checkpoint['gen_state_dict'])
        #    gen_net.module.load_state_dict(checkpoint[new_state_dict])
        #    dis_net.module.load_state_dict(checkpoint['dis_state_dict'])
        #try:
    ...
    for step in range(steps):
        ...
        new_layers, approx_error, layer_compress_ratio = decompose_and_replace_conv_layer_by_name(gen_net.module, layer_name, rank=rank, freeze=False, device=args.gpu_ids[0])
