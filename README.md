# ENHANCING GAN PERFORMANCE THROUGH NEURAL ARCHITECTURE SEARCH AND TENSOR DECOMPOSITION (MMD-AdversarialNAS) [[PDF (Full Text)]](https://prasannapulakurthi.github.io/papers/PDFs/2024_ICASSP_GANs-Tensor-Decomposition.pdf) [[PPT (Presentation Slides)]](https://sigport.org/documents/enhancing-gan-performance-through-neural-architecture-search-and-tensor-decomposition) [[Paper (DOI)]](https://ieeexplore.ieee.org/document/10446488)
