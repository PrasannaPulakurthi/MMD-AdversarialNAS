# ENHANCING GAN PERFORMANCE THROUGH NEURAL ARCHITECTURE SEARCH AND TENSOR DECOMPOSITION (MMD-AdversarialNAS) [[PDF]](https://prasannapulakurthi.github.io/papers/PDFs/2024_ICASSP_GANs-Tensor-Decomposition.pdf) [[Paper]](https://ieeexplore.ieee.org/document/10446488)
...
**2024/11 Update**: An extended version of this paper titled "Enhancing GANs with MMD Neural Architecture Search, PMish Activation Function, and Adaptive Rank Decomposition" has been accepted by IEEE Access [[Paper]](https://ieeexplore.ieee.org/document/10732016) [[Website]](https://prasannapulakurthi.github.io/mmdpmishnas/). The latest version of the code can be found [here](https://github.com/PrasannaPulakurthi/MMD-PMish-NAS). 
