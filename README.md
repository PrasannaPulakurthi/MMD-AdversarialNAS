# ENHANCING GAN PERFORMANCE THROUGH NEURAL ARCHITECTURE SEARCH AND TENSOR DECOMPOSITION (MMD-AdversarialNAS) [[Paper]](https://ieeexplore.ieee.org/document/10446488)
...
**2024/11 Update**: Our paper "Enhancing GANs with MMD Neural Architecture Search, PMish Activation Function, and Adaptive Rank Decomposition" has been accepted by IEEE Access [[Paper]](https://ieeexplore.ieee.org/document/10732016) [[Website]](https://prasannapulakurthi.github.io/mmdpmishnas/). The latest version of the code can be found [here](https://github.com/PrasannaPulakurthi/MMD-PMish-NAS). 
