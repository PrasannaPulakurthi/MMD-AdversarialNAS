...
#python MGPU_compress_arch.py --gpu_ids 7 --num_workers 8 --dataset cifar10 --bottom_width 4 --img_size 32 --arch arch_cifar10 --draw_arch False --checkpoint arch_train_cifar10_ncritic1__2023_06_12_15_26_21 --genotypes_exp arch_cifar10 --compress-mode "allatonce" --latent_dim 120 --gf_dim 256 --df_dim 512 --num_eval_imgs 50000 --eval_batch_size 200 --exp_name 'all_layers-mixed_3' --ft-epochs 1000 --val_freq 10 --byrank --rank 8 16 64 64 128 64 64 128 512 128 256 64 512 --layers $layers_str --gen_bs  256 --dis_bs 256
