...
#python MGPU_cpcompress_arch.py --gpu_ids 0 --num_workers 18 --dataset cifar10 --bottom_width 4 --img_size 32 --arch arch_cifar10 --draw_arch False --checkpoint arch_train_cifar10_smallG --genotypes_exp arch_cifar10 --compress-mode "allatonce" --latent_dim 120 --gf_dim 128 --df_dim 640 --num_eval_imgs 50000 --eval_batch_size 100 --exp_name '5_layers-CP' --ft-epochs 1000 --val_freq 10 --byrank --rank 500 --layers $layers_str --gen_bs  256 --dis_bs 256