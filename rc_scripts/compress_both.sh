...
# 10 layers
#layers=('cell1.c0.ops.0.op.1' 'cell1.c1.ops.0.op.1' 'cell1.c2.ops.0.op.1' 'cell1.c3.ops.0.op.1' 'cell2.c2.ops.0.op.1' 'cell2.c3.ops.0.op.1' 'cell2.c4.ops.0.op.1' 'cell3.c1.ops.0.op.1' 'cell3.c2.ops.0.op.1' 'cell3.c3.ops.0.op.1')
dis_layers=('l5') # #'block3.c1' 'block3.c2' 'block4.c1' 'block4.c2'
# 8 layers - 3
layers=('cell1.c1.ops.0.op.1' 'cell1.c2.ops.0.op.1' 'cell1.c3.ops.0.op.1' 'cell3.c2.ops.0.op.1' 'cell3.c3.ops.0.op.1')

reverse_g_freeze=false
#reverse_d_freeze=false
gfreeze=true
dfreeze=true
...
exp_name+="normalizeddecomp-${glen}layersof8-${dlen}layers-${R}gr-${r}dr-bu${bu}_lr${lr}_${rid}"

python MGPU_cpcompress_both_arch_new.py --gpu_ids 0 --num_workers 18 --dataset cifar10 --bottom_width 4 --img_size 32 --arch arch_cifar10 --draw_arch False --checkpoint arch_train_cifar10_bu4 --genotypes_exp arch_cifar10 --compress-mode "allatonce" --latent_dim 120 --gf_dim 256 --df_dim 512 --num_eval_imgs 50000 --eval_batch_size 200 --exp_name $exp_name --max_epoch_G 500 --val_freq 5 --byrank --rank ${R} --layers $layers_str --gen_bs  512 --dis_bs 512 --bu $bu --dis_layers $dis_layers_str --dis_rank $r --g_lr $lr --d_lr $lr --freeze_layers $freeze_layers_str --reverse_g_freeze --eval_before_compression #--ft-epochs 100 #--g_lr2 0.000002 --d_lr2 0.000002 #  # --lr_decay   --eval_before_compression
#if [ "$reverse_g_freeze" = true ] ; then
#    python MGPU_cpcompress_both_arch_new.py --gpu_ids 0 --num_workers 18 --dataset cifar10 --bottom_width 4 --img_size 32 --arch arch_cifar10 --draw_arch False --checkpoint arch_train_cifar10_bu4 --genotypes_exp arch_cifar10 --compress-mode "allatonce" --latent_dim 120 --gf_dim 256 --df_dim 512 --num_eval_imgs 50000 --eval_batch_size 200 --exp_name $exp_name --max_epoch_G 1000 --val_freq 5 --byrank --rank ${R} --layers $layers_str --gen_bs  512 --dis_bs 512 --bu $bu --dis_layers $dis_layers_str --dis_rank $r --g_lr $lr --d_lr $lr --freeze_layers $freeze_layers_str --reverse_g_freeze --eval_before_compression   
#else
#    python MGPU_cpcompress_both_arch_new.py --gpu_ids 0 --num_workers 18 --dataset cifar10 --bottom_width 4 --img_size 32 --arch arch_cifar10 --draw_arch False --checkpoint arch_train_cifar10_bu4 --genotypes_exp arch_cifar10 --compress-mode "allatonce" --latent_dim 120 --gf_dim 256 --df_dim 512 --num_eval_imgs 50000 --eval_batch_size 200 --exp_name $exp_name --max_epoch_G 1000 --val_freq 5 --byrank --rank ${R} --layers $layers_str --gen_bs  512 --dis_bs 512 --bu $bu --dis_layers $dis_layers_str --dis_rank $r --g_lr $lr --d_lr $lr --freeze_layers $freeze_layers_str --reverse_g_freeze --eval_before_compression   
#fi
