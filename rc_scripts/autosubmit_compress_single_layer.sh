...
for layer in ${layers[@]}; do
    ...
    echo $EXPNAME
    EXPNAME="singlelayercompress-nofreeze-L${layer_id}-${layer}"
    ...
    EXPNAME="singlelayercompress-freeze-L${layer_id}-${layer}"
    ...
    EXPNAME="singlelayercompress-reversefreeze-L${layer_id}-${layer}"
